...
import zhou.akka.AbstractJavaTest;

import static java.util.concurrent.TimeUnit.SECONDS;

public class FaultHandingTest extends AbstractJavaTest {
    // #testkit
    ...
    public void mustEmploySupervisorStrategy() throws Exception {
        ...
        system.getEventStream().publish(new TestEvent.Mute(Util.immutableSeq(ignoreExceptions)));
