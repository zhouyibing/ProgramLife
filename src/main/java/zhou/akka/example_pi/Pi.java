...
public class Pi {
    ...
    /********* message  define *******/
    //Calculate 每 sent to the Master actor to start the calculation
    static class Calculate{}

    //Work 每 sent from the Master actor to the Worker actors containing the work assignment
    static class Work{
    ...
    //Result 每 sent from the Worker actors to the Master actor containing the result from the worker＊s calculation
    static class Result{
    ...
    //PiApproximation 每 sent from the Master actor to the Listener actor containing the the final pi result and how long time the calculation took
